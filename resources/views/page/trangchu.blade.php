			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-12">
						...
						<div class="beta-products-list">
							<h4 style="color: blue">Sản phẩm khuyến mại</h4>
							<div class="beta-products-details">
								<p class="pull-left"> Tìm thấy {{count($promotion_product)}} </p>
								<div class="clearfix"></div>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item" style="margin-bottom: 10px">
										<div class="single-item-header">
											<a href="{{route('chitietsanpham', $promotion->id)}}"><img src="source/image/product/{{$promotion->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body" >
